...
GLM 2 aims to quantify responses to navigation events as function of angular difference of the running direction to the orientation estimated based on GLM 1. This can be done using different ways.
For now, we will implement the parametric modulation and the aligned vs. misaligned approach.
